...
(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        define('iosync',['backbone', 'underscore', 'socket.io', 'jquery'], factory);
...
(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        // AMD. Register as an anonymous module.
        define('iobind',['backbone', 'underscore', 'socket.io', 'jquery'], factory);
    } else if (typeof exports === 'object') {
        // Node. Does not work with strict CommonJS, but
        // only CommonJS-like environments that support module.exports,
        // like Node.
...
define('models/messages',['jquery', 'underscore', 'backbone', 'socket', 'iosync', 'iobind'],
...
define('collections/messages',['jquery', 'underscore', 'backbone', 'socket', 'iosync', 'iobind', 'models/messages'],
...
define('text!views/../../views/messages.mustache',[],function () { return '<strong>{{name}}</strong>: {{message}}';});

// MessagesView

define('views/messages',['jquery', 'underscore', 'backbone', 'mustache', 'collections/messages', 'text!./../../views/messages.mustache'],
...
define('views/app',['jquery', 'underscore', 'backbone', 'collections/messages', 'views/messages'],
...
define('router',['jquery', 'underscore', 'backbone', 'views/app'],
